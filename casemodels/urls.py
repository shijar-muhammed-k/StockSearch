...
urlpatterns = [
    ...
    path('designs-<ctype>', views.searchCase, name='search'),
    ...
    path('delete-<ctype>', views.deleteCase, name='deleteCase'),
    path("edit-<ctype>-<dtype>", views.adminEditDesign, name='editDesign'),
    path("deletedesign-<ctype>-<dtype>", views.deleteDesign, name='deleteDesign'),
    path("updateStock-<ctype>-<dtype>", views.updateStock , name='updateStock')
